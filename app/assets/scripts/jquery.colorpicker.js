/*jslint devel: true, bitwise: true, regexp: true, brcolorHandlerowser: true, confusion: true, unparam: true, eqeq: true, white: true, nomen: true, plusplus: true, maxerr: 50, indent: 4 */
...
;(function ($) {
	...
	$.widget("vanderlee.colorpicker", {
		options: {
			...
			parts:				'inline',			// leave empty for automatic selection
			part: {
				map:		{ size: 256 },
				bar:		{ size: 256 }
			},			// options per part
